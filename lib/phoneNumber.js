...
class PhoneNumber {
  ...
  parse(number, iso2) {
    try {
      ...
      if (
        msg !== "Error: The string supplied is too short to be a phone number" &&
        msg !== "Error: The string supplied did not seem to be a phone number"
      )
        console.log(`Exception was thrown: ${msg}`);
      return null;
    }
  }
